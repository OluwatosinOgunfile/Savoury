...
export function Footer() {
  return (
    <footer className="border-t border-white/10 bg-[#f4f4f4] text-zinc-700">
      <div className="app-container grid gap-10 py-12 md:grid-cols-[1.1fr_0.8fr_1fr_1fr]">
        ...
        <div>
          <h3 className="font-black text-zinc-950">Quick Links</h3>
        ...
        <div>
          <h3 className="font-black text-zinc-950">Contact Us</h3>
        ...
        <div>
          <h3 className="font-black text-zinc-950">Opening Hours</h3>
      ...
      <div className="app-container flex flex-col justify-between gap-3 border-t border-zinc-200 py-5 text-xs text-zinc-500 sm:flex-row">
